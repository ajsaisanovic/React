...
function PredmetInformacije({naziv, asistent,profesor,termin_predavanja,termin_vjezbi,osoblje,god,sem,id,tip}){
    ...
    function spasi(){
        setForma(!forma)
        axios.post('http://127.0.0.1:8000/dws/promijeniPredmet/',{
            naziv:predmet,
            profesor:profesor,
            asistent:asistent,
            vjezbe:vjezbe,
    ...
    function izbrisi(){
        axios.post('http://127.0.0.1:8000/dws/izbrisiPredmet/',{
            ...
            <Col xs={5}>
                ...
                <p>Termin vježbi: {termin_vjezbi}</p>
                    {tip==="Šef odsjeka"|| tip==="Dekan"?
                        ...
                        <Button variant="primary" onClick={() => setForma(!forma)}>Uredi</Button>
                        </div>:<div></div>
                    }
                    {forma?
